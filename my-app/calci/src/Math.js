  ...
  return (
    <div>
      ...
      <div className="keypad">
        ...
        <button className='highlight' name='Factor' onClick={factorial}>!</button><br></br>
        <button className='highlight' name='Sin' onClick={Sin}>Sin</button>
        <button className='highlight' name='Cos' onClick={Cos}>Cos</button>
        <button className='highlight' name='Tan' onClick={Tan}>Tan</button><br></br>
        <button className='highlight' name='log' onClick={log}>log</button>
        <button className='highlight' name='x^2' onClick={square}>X^2</button>
        <button className='highlight' name='√' onClick={squareroot}>√</button><br></br>
        <button name='7' onClick={handleClick}>7</button>
        <button name='8' onClick={handleClick}>8</button>
        <button name='9' onClick={handleClick}>9</button>
        <button className='highlight' name='/' onClick={handleClick}>&divide;</button><br></br>
        <button name='4' onClick={handleClick}>4</button>
        <button name='5' onClick={handleClick}>5</button>
        <button name='6' onClick={handleClick}>6</button>
        <button className='highlight' name='*' onClick={handleClick}>&times;</button><br></br>
        <button name='1' onClick={handleClick}>1</button>
        <button name='2' onClick={handleClick}>2</button>
        <button name='3' onClick={handleClick}>3</button>
        <button className='highlight' name='-' onClick={handleClick}>&ndash;</button><br></br>
        <button name='0' onClick={handleClick}>0</button>
        <button className='highlight' name='+' onClick={handleClick}>+</button>
        
        <button className='highlight' name='.' onClick={handleClick}>.</button>
        <button onClick={calculate} id='result'>=</button><br></br>
